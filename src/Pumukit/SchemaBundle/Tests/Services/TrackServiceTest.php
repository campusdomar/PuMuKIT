 ...
 * @coversNothing
 */
final class TrackServiceTest extends WebTestCase
{
    private $dm;
    private $repoJobs;
    private $repoMmobj;
    ...
    public function testAddTrackToMultimediaObject()
    {
        ...
        static::assertSame($track, $embeddedTrack);
    }
    ...
    public function testUpdateTrackInMultimediaObject()
    {
        ...
        $multimediaObject = $this->repoMmobj->find($multimediaObject->getId());
        $track = $multimediaObject->getTracks()[0];
        static::assertSame($newUrl, $track->getUrl());
    }
    ...
    public function testRemoveTrackFromMultimediaObject()
    {
        ...
        static::assertSame(1, \count($multimediaObject->getTracks()));
    ...
    public function testUpAndDownTrackInMultimediaObject()
    {
        ...
        static::assertSame(5, \count($multimediaObject->getTracks()));

        $arrayTracks = [$track1, $track2, $track3, $track4, $track5];
        static::assertSame($arrayTracks, $multimediaObject->getTracks()->toArray());

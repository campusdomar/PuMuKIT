 ...
 * @coversNothing
 */
final class PicServiceTest extends WebTestCase
{
    private $dm;
    ...
    public function testGetDefaultUrlPicForObject()
    {
        ...
        $absolute = false;
        static::assertSame($this->defaultVideoPic, $this->picService->getDefaultUrlPicForObject($pic, $absolute));

        $absolute = true;
        static::assertSame($this->localhost.$this->defaultVideoPic, $this->picService->getDefaultUrlPicForObject($pic, $absolute));
    }
    ...
    public function testGetDefaultPathPicForObject()
    {
        ...
        static::assertSame($this->webDir.$this->defaultVideoPic, $this->picService->getDefaultPathPicForObject($pic));
    }
    ...
    public function testGetFirstUrlPic()
    {
        ...
        $absolute = false;
        static::assertSame($this->defaultSeriesPic, $this->picService->getFirstUrlPic($series, $absolute));

        $absolute = true;
        static::assertSame($this->localhost.$this->defaultSeriesPic, $this->picService->getFirstUrlPic($series, $absolute));
        ...
        static::assertSame($seriesUrl1, $this->picService->getFirstUrlPic($series));
        ...
        static::assertSame($seriesUrl2, $this->picService->getFirstUrlPic($series));
        ...
        $absolute = false;
        static::assertSame($this->defaultVideoPic, $this->picService->getFirstUrlPic($mm, $absolute));

        $absolute = true;
        static::assertSame($this->localhost.$this->defaultVideoPic, $this->picService->getFirstUrlPic($mm, $absolute));
        ...
        $absolute = false;
        $hd = true;
        static::assertSame($this->defaultAudioHDPic, $this->picService->getFirstUrlPic($mm, $absolute, $hd));
        $hd = false;
        static::assertSame($this->defaultAudioSDPic, $this->picService->getFirstUrlPic($mm, $absolute, $hd));

        $absolute = true;
        $hd = true;
        static::assertSame($this->localhost.$this->defaultAudioHDPic, $this->picService->getFirstUrlPic($mm, $absolute, $hd));
        $hd = false;
        static::assertSame($this->localhost.$this->defaultAudioSDPic, $this->picService->getFirstUrlPic($mm, $absolute, $hd));
        ...
        static::assertSame($mmUrl1, $this->picService->getFirstUrlPic($mm));

        $absolute = true;
        static::assertSame($this->localhost.$mmUrl1, $this->picService->getFirstUrlPic($mm, $absolute));
        ...
        static::assertSame($mmUrl2, $this->picService->getFirstUrlPic($mm));

        $absolute = true;
        static::assertSame($this->localhost.$mmUrl2, $this->picService->getFirstUrlPic($mm, $absolute));
    }
    ...
    public function testGetFirstPathPic()
    {
        ...
        static::assertSame($this->webDir.$this->defaultSeriesPic, $this->picService->getFirstPathPic($series));
        ...
        static::assertSame($seriesPath1, $this->picService->getFirstPathPic($series));
        ...
        static::assertSame($seriesPath2, $this->picService->getFirstPathPic($series));
        ...
        static::assertSame($this->webDir.$this->defaultVideoPic, $this->picService->getFirstPathPic($mm));
        ...
        $hd = true;
        static::assertSame($this->webDir.$this->defaultAudioHDPic, $this->picService->getFirstPathPic($mm, $hd));
        $hd = false;
        static::assertSame($this->webDir.$this->defaultAudioSDPic, $this->picService->getFirstPathPic($mm, $hd));
        ...
        static::assertSame($mmPath1, $this->picService->getFirstPathPic($mm));
        ...
        static::assertSame($mmPath2, $this->picService->getFirstPathPic($mm));
    }

 ...
 * @coversNothing
 */
final class LinkServiceTest extends WebTestCase
{
    private $dm;
    private $repoMmobj;
    private $linkService;
    ...
    public function testAddLinkToMultimediaObject()
    {
        ...
        static::assertSame(1, \count($mm->getLinks()));
    }
    ...
    public function testUpdateLinkInMultimediaObject()
    {
        ...
        static::assertSame(1, \count($mm->getLinks()));
        static::assertSame($name, $mm->getLinkById($link->getId())->getName());
        ...
        static::assertSame($newName, $mm->getLinkById($link->getId())->getName());
    }
    ...
    public function testUpAndDownLinkInMultimediaObject()
    {
        ...
        static::assertSame($links, $mm->getLinks()->toArray());

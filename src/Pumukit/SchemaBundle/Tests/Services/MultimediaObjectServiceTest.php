 ...
 * @coversNothing
 */
final class MultimediaObjectServiceTest extends WebTestCase
{
    private $dm;
    private $repo;
    private $tagRepo;
    ...
    public function testCanBeDisplayed()
    {
        ...
        static::assertTrue($this->mmsService->canBeDisplayed($mm, $webTVCode));
    }
    ...
    public function testResetMagicUrl()
    {
        ...
        static::assertNotSame($secret, $this->mmsService->resetMagicUrl($mm));
    }
    ...
    public function testUpdateMultimediaObject()
    {
        ...
        static::assertSame($newTitle, $multimediaObject->getTitle());
    }
    ...
    public function testIncNumView()
    {
        ...
        static::assertSame(0, $mm->getNumView());

        $this->mmsService->incNumView($mm);
        static::assertSame(1, $mm->getNumView());
    }
    ...
    public function testAddGroup()
    {
        ...
        static::assertSame(0, \count($multimediaObject->getGroups()));
        ...
        static::assertSame(1, \count($multimediaObject->getGroups()));
        ...
        static::assertSame(2, \count($multimediaObject->getGroups()));
        static::assertTrue($multimediaObject->containsGroup($group1));
        ...
        static::assertSame(3, \count($multimediaObject->getGroups()));
        static::assertTrue($multimediaObject->containsGroup($group1));
        static::assertTrue($multimediaObject->containsGroup($group2));
    ...
    public function testDeleteAllFromGroup()
    {
        ...
        static::assertSame(0, \count($this->repo->findWithGroup($group)->toArray()));
        ...
        static::assertSame(3, \count($this->repo->findWithGroup($group)->toArray()));

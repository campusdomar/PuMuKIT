...
final class PlaylistTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        static::assertSame([], $playlist->getMultimediaObjectsIdList());
    }
    ...
    public function testMoveMultimediaObject()
    {
        ...
        static::assertSame(0, $playlist->getPlaylist()->getMultimediaObjects()->count());
        ...
        static::assertSame($oldArray, $playlist->getPlaylist()->getMultimediaObjects()->toArray());
        ...
        static::assertSame($mmobjs, $playlist->getPlaylist()->getMultimediaObjects()->toArray());
        //Move one.

 ...
 * @coversNothing
 */
final class EventPicServiceTest extends WebTestCase
{
    private $dm;
    private $repo;
    ...
    public function testAddPicUrl()
    {
        ...
        static::assertSame($url, $event->getPic()->getUrl());
        static::assertSame($url, $this->repo->find($event->getId())->getPic()->getUrl());
    }
